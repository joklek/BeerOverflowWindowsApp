...
namespace BeerOverflowWindowsApp.UnitTests
{
    public class GetBarListFourSquareUnitTests
    {
        ...
        public void GetBarsFourSquare_GetBarsAround_ValidData(string latitude, string longitude, string radius)
        {
            ...
            validFetcher.Setup(p => p.GetHttpStream(It.IsAny<string>())).Returns(BarProviderTestData.FourSquareValidDataResponse);
            var getBars = new GetBarListFourSquare(validFetcher.Object);
            // Act
        ...
        public void GetBarsFourSquare_GetBarsAroundAsync_ValidData(string latitude, string longitude, string radius)
        {
            // Arrange
            var validFetcher = new Mock<IHttpFetcher>();
            validFetcher.Setup(p => p.GetHttpStreamAsync(It.IsAny<string>())).Returns(Task.Run(() => BarProviderTestData.FourSquareValidDataResponse));
            var getBars = new GetBarListFourSquare(validFetcher.Object);
            // Act
        ...
        public void GetBarsFourSquare_GetBarsAround_NullData(string latitude, string longitude, string radius)
        {
            ...
            // Arrange
            var getBars = new GetBarListFourSquare(emptyFetcher.Object);
            // Act && Assert
        ...
        public void GetBarsFourSquare_GetBarsAround_InvalidData(string latitude, string longitude, string radius, string exceptionMessage)
        {
            var emptyFetcher = new Mock<IHttpFetcher>();
            emptyFetcher.Setup(p => p.GetHttpStream(It.IsAny<string>())).Throws(new Exception("This should not have been thrown"));
            // Arrange
        ...
        [TestCaseSource(typeof(BarProviderTestData), "InvalidDataCases")]
        public void GetBarsFourSquare_GetBarsAroundAsync_InvalidData(string latitude, string longitude, string radius, string exceptionMessage)
        {
            var emptyFetcher = new Mock<IHttpFetcher>();
            emptyFetcher.Setup(p => p.GetHttpStream(It.IsAny<string>())).Throws(new Exception("This should not have been thrown"));
            // Arrange
