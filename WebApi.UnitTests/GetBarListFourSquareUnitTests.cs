...
namespace WebApi.UnitTests
{
    public class GetBarListFourSquareUnitTests
    {
        ...
        public void GetBarsFourSquare_GetBarsAround_InvalidData(double latitude, double longitude, double radius, string exceptionMessage)
        {
        ...
        [TestCaseSource(typeof(BarProviderTestData), "InvalidDataCases")]
        public void GetBarsFourSquare_GetBarsAroundAsync_InvalidData(double latitude, double longitude, double radius, string exceptionMessage)
        {
            var emptyFetcher = new Mock<IHttpFetcher>();
            emptyFetcher.Setup(p => p.GetHttpStream(It.IsAny<string>())).Throws(new Exception("This should not have been thrown"));
            // Arrange
